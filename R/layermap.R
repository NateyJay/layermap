...
#'
#' @param value.df numerical dataframe or matrix with column name and row names. Everything that is included in the dataframe will be plotted as the heatmap, meaning that including any non-numeric values will lead layermap to interpret this as a categorical heatmap.
